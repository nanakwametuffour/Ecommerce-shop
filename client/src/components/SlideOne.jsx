  ...
  return (
    <div className="flex flex-col my-3 gap-5">
      <div className="border-b-2 p-1">
        <h1 className=" uppercase font-semibold">top sells clothes</h1>
      </div>
